...
== Changelog ==
= 5.4.1 =
* Fixed editor errors on cloning
* Fixed photo upload feature

= 5.4.0 =
* Replaced popup editor with inline WYSIWYG editor for biography fields
* Reduced default editor height for better UX
